...
public class PointsBestDisplay extends PointsDisplay {

    public PointsBestDisplay(CoreFont font, Score score, int x, int y, Filter filter) {
	super(font, score, x, y, filter);
    }

    @Override
    protected int getValue() {
	return score.getBestPoints();
    }
